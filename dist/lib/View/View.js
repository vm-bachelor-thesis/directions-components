...
import { View as RNView, SafeAreaView, ScrollView, StyleSheet, KeyboardAvoidingView, Platform, } from 'react-native';
...
export var View = function (_a) {
    ...
    if (type === 'container') {
        return (<KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={templates.keyboardAvoidingView}>
